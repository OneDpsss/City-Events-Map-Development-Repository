...
Street (if possible), Building (if possible). Note that all events take place in the Nizhny Novgorod. Do not 
separate into separate entities.", "description": "Rephrase the information to provide a more precise context and 
avoid unnecessary emotional inserts.",  "priority": where 3 -  "High importance: Events that significantly affect all or 
