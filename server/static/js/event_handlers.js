...
var eventDate = new Date(eventData.event_date); 
var formattedEventDate = eventDate.toLocaleString('ru-RU', {day: '2-digit', month: '2-digit', year: 'numeric', hour: '2-digit', minute: '2-digit'}); 
var fullEventContent = '<div style="display: flex; justify-content: space-between; align-items: center;">' + 
                          ...
                          '<p style="color: #888;">' + formattedEventDate + '</p>' + 
